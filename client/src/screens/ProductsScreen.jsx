...
const ProductsScreen = () => {
    ...
    const {loading, error, products, pagination, favouritesToggled } = useSelector((state) => state.product);
            ...
            {products.length >= 1 && (
                <Box>
                    ...
                    <Wrap spacing='10px' justify='center' p='5'>
                        <Button colorScheme="cyan" onClick={() => paginationButtonClick(1)} ><ArrowLeftIcon /></Button>
                        ...
                        <Button colorScheme="cyan" onClick={() => paginationButtonClick(pagination.totalPages)} ><ArrowRightIcon /></Button>
